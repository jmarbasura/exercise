-- Verify id.me:alter_table_only/music.streaming_plays-music.streaming_plays_y2024m01 on pg
...
BEGIN
  ...
  ASSERT (select exists (                                   
                         ...
                         WHERE c.oid = i.inhrelid 
                           ...
                           AND i.inhrelid IN (select oid from pg_class where relnamespace::regnamespace::text='music' and relname='music.streaming_plays_y2024m01')
